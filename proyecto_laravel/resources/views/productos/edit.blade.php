    ...
    <div class="container">
        ...
        <form action="{{ route('productos.update', $producto) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="supermercado_id" class="form-control" required>
                    @foreach($supermercados as $supermercado)
                        <option value="{{ $supermercado->id }}" {{ $supermercado->id == $producto->supermercado_id ? 'selected' : '' }}>
                            {{ $supermercado->nombre }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="fecha_caducidad" class="form-control" id="fecha_caducidad" value="{{ $producto->fecha_caducidad }}" required>
            </div>
            <div class="mb-3">
